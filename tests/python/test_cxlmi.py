...
class TestStructures(unittest.TestCase):
    ...
    def test_timestamp_structure(self):
        ...
        ts_get = cxlmi.cxlmi_cmd_get_timestamp()
        ts_set = cxlmi.cxlmi_cmd_set_timestamp()
    ...
    def test_memdev_identify_structure(self):
        ...
        memdev = cxlmi.cxlmi_cmd_memdev_identify()
    ...
    def test_partition_info_structure(self):
        ...
        get_part = cxlmi.cxlmi_cmd_memdev_get_partition_info()
        set_part = cxlmi.cxlmi_cmd_memdev_set_partition_info()
    ...
    def test_fw_info_structure(self):
        ...
        fw_info = cxlmi.cxlmi_cmd_get_fw_info()
    ...
    def test_poison_structures(self):
        ...
        poison_inject = cxlmi.cxlmi_cmd_memdev_inject_poison()
        poison_clear = cxlmi.cxlmi_cmd_memdev_clear_poison()
    ...
    def test_security_structures(self):
        ...
        sec_state = cxlmi.cxlmi_cmd_memdev_get_security_state()
        set_pass = cxlmi.cxlmi_cmd_memdev_set_passphrase()
        unlock = cxlmi.cxlmi_cmd_memdev_unlock()
    ...
    def test_qos_structures(self):
        """Test QoS structures"""
        qos_get = cxlmi.cxlmi_cmd_memdev_get_sld_qos_control()
        qos_set = cxlmi.cxlmi_cmd_memdev_set_sld_qos_control()
        qos_status = cxlmi.cxlmi_cmd_memdev_get_sld_qos_status()
...
class TestCommandRequestStructures(unittest.TestCase):
    ...
    def test_clear_event_records(self):
        ...
        req = cxlmi.cxlmi_cmd_clear_event_records()
        req.event_log = 0x00
    ...
    def test_scan_media_request(self):
        ...
        req = cxlmi.cxlmi_cmd_scan_media()
    ...
    def test_fmapi_bind_vppb(self):
        ...
        req = cxlmi.cxlmi_cmd_fmapi_bind_vppb()
        req.vcs_id = 1
        req.vppb_id = 5
        req.port_id = 3
        req.ld_id = 10
    ...
    def test_fmapi_unbind_vppb(self):
        ...
        req = cxlmi.cxlmi_cmd_fmapi_unbind_vppb()
        req.vcs_id = 1
        req.vppb_id = 5
        req.option = 0
    ...
    def test_fmapi_phys_port_control(self):
        ...
        req = cxlmi.cxlmi_cmd_fmapi_phys_port_control()
        req.ppb_id = 2
...
class TestFlexibleArrayStructures(unittest.TestCase):
    ...
    def test_supported_logs(self):
        ...
        logs = cxlmi.cxlmi_cmd_get_supported_logs()
    ...
    def test_firmware_info(self):
        ...
        fw = cxlmi.cxlmi_cmd_get_fw_info()
